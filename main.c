...
int main ()
{
  ...
  counter_list_a = (NextNodeCounter **) malloc (sizeof (void *));
  NextNodeCounter **counter_list_b;
  counter_list_b = (NextNodeCounter **) malloc (sizeof (void *));
  ...
  counter_list_a[0] = &b_as_next;
  counter_list_b[0] = &a_as_next;
  Node *a_node;
